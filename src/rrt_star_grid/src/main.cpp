...
int main(int argc, char **argv)
{
  ...
  n.param<double>("rrt_star_grid_node/start_x", start_x, 0.0);
  n.param<double>("rrt_star_grid_node/start_y", start_y, 0.0);
  n.param<double>("rrt_star_grid_node/goal_x", goal_x, 15.0);
  n.param<double>("rrt_star_grid_node/goal_y", goal_y, 15.0);
  n.param<double>("rrt_star_grid_node/step", step, 2.0);
  n.param<double>("rrt_star_grid_node/size_x_min", size_x_min, -16.0);
  n.param<double>("rrt_star_grid_node/size_x_max", size_x_max, 16.0);
  n.param<double>("rrt_star_grid_node/size_y_min", size_y_min, -16.0);
  n.param<double>("rrt_star_grid_node/size_y_max", size_y_max, 16.0);
  ...
  RRTSTARGRID rrtstargridPlanner(start, goal, step, size_x_min, size_x_max, size_y_min, size_y_max, near_area_radius);
