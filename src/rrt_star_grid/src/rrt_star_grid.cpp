...
RRTSTARGRID::RRTSTARGRID(Node &start, Node &goal, const double step, const double size_x_min, const double size_x_max,
...
void RRTSTARGRID::setObastacle()
{

}

void RRTSTARGRID::checkObstacle()
{
